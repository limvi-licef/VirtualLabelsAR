...
class Ui_WindowsDevicePortal(object):
    ...
    def retranslateUi(self, WindowsDevicePortal):
        ...
        self.passwordInput.setText(_translate("WindowsDevicePortal", "limvi12216"))
        ...
        self.hostInput.setText(_translate("WindowsDevicePortal", "https://10.44.161.15"))
        self.loginLabel.setText(_translate("WindowsDevicePortal", "Login"))
        self.loginInput.setText(_translate("WindowsDevicePortal", "limvi.licef"))
