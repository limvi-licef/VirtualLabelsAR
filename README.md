...
- Ouvrez les propriétés de déboguage, section déboguage, dans le champs "nom de l'orinateur", placez y l'adresse IP de la Hololens (disponible dans les paramètres réseau de la Hololens).
