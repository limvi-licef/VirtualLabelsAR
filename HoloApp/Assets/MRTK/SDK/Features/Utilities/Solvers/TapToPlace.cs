...
namespace Microsoft.MixedReality.Toolkit.Utilities.Solvers
{
    ...
    public class TapToPlace : Solver, IMixedRealityPointerHandler
    {
        ...
        //Create a spatial anchor when the object is placed
        [SerializeField]
        ...
        {
            worldAnchorManager = (WorldAnchorManager)FindObjectOfType(typeof(WorldAnchorManager));
            base.Start();
        ...
        public void StartPlacement()
        {
            ...
            if (!IsBeingPlaced)
            {
                //Remove the anchor to allow the object to be moved
        ...
        public void StopPlacement()
        {
            ...
            if (IsBeingPlaced)
            {
                //Attach anchor to the object when it is placed
